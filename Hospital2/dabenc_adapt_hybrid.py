...
import re
debug = False
def parse_policy_to_abe_format(policy_text, attributes_prefix="hospitalB"):
    # Normalize
...
def main():
    ...
    bobs_gid = "user_12345"
    K = {}
    hyb_abema.keygen(gp, hosBSK,'hospitalB.doctor', bobs_gid, K)
    hyb_abema.keygen(gp, hosBSK,'hospitalB.oncology', bobs_gid, K)
    hyb_abema.keygen(gp, hosBSK,'hospitalB.clearance2', bobs_gid, K)
    base_path = "/Hospital2/patients"
