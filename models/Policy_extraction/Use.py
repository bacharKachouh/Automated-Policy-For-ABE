...
#input_text = input("Enter the path to the directory (or type 'exit' to quit): ").strip()
...
base_path = "/home/bachar/DCSM/Hospital1/patients/"
user_id = input("Enter the Patient ID (or type 'exit' to quit): ").strip()
full_path = os.path.join(base_path, f"Patient_{user_id}", "Accesspolicy",f"Patient_{user_id}_1.txt")
print(full_path)
with open(full_path, "w") as file:
    file.write(access_policy)
